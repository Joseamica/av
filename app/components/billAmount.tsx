...
export function BillAmount({
  ...
  return (
    // <div className="dark:text-mainTextDark space-y-2 rounded-lg bg-white p-4 shadow-md  dark:shadow-none ">
    ...
    //               className="dark:fill-DARK_PRIMARY_1 fill-principal"
    //             ></path>
    //           </svg>
    //         </div>
    //       </FlexRow>
    ...
    //   </AnimatePresence>
    // </div>
    <main className="flex w-full flex-col space-y-2 p-2">
