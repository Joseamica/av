...
function QuantityButton({
  ...
  return (
    <div className="flex items-center justify-between w-32 rounded-full px-1 bg-button-primary">
      ...
      {isForm ? (
        <>
          {quantity <= 1 ? (
            <button
              type={'submit'}
              className="flex items-center justify-center w-8 h-8 text-2xl rounded-full shadow-lg bg-mainDark text-night-text_principal bg-day-bg_principal text-warning disabled:text-gray-300 xs:h-7 xs:w-7"
              onClick={onDecrease}
              disabled={disabled}
              name={name}
              value={decreaseValue}
            ...
            <button
              ...
              className="w-8 h-8 text-2xl rounded-full shadow-lg bg-mainDark bg-night-bg_principal text-night-text_principal bg-day-bg_principal disabled:text-gray-300 xs:h-7 xs:w-7"
              onClick={onDecrease}
              disabled={disabled}
              name={name}
              value={decreaseValue}
      ...
      <button
        type={isForm ? 'submit' : 'button'}
        onClick={onIncrease}
        className="w-8 h-8 text-2xl rounded-full shadow-lg bg-mainDark bg-night-bg_principal text-night-text_principal bg-day-bg_principal xs:h-7 xs:w-7"
        name={name}
        value={increaseValue}
      >
        +
