    ...
    <>
      ...
      <Field
        ...
        inputProps={{
          ...
          defaultValue: isEditing ? employees.find(employee => employee.id === editSubItemId)?.paid : '',
          type: 'number',
        }}
      ...
      <Field
        ...
        inputProps={{
          ...
          defaultValue: isEditing ? employees.find(employee => employee.id === editSubItemId)?.tip : '',
          type: 'number',
        }}
