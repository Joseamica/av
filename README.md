...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create av-51be
  fly apps create av-51be-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app av-51be
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app av-51be-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'av-51be-staging' does not match app name in config file 'av-51be'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name av-51be-db
  fly postgres attach --app av-51be av-51be-db

  fly postgres create --name av-51be-staging-db
  fly postgres attach --app av-51be-staging av-51be-staging-db
  ```
